const projects = [
  {
    id: 'kiserian-house',
    name: 'Kiserian House',
    cardSubtitle: 'Contemporary Residential Architecture',
    ...
    typology: 'Contemporary 3-Bedroom Bungalow',
    ...
    seoKeywords: [
      ...
      'Residential architecture Kenya',
      '3-bedroom bungalow design',
      'Minimal tropical architecture',
      'Studio 39+',
      'Modern African residential architecture'
    ],
    gallery: [
      {
  ...
  },
  {
    ...
    name: 'Saika House',
    cardSubtitle: 'Contemporary Residential Architecture',
    category: 'Contemporary Private Residence',
    location: 'Saika, Nairobi, Kenya',
    year: '2026',
    status: 'Construction Drawings / Residential Development',
    studio: 'Studio 39+',
    architect: 'Franklin Ombui',
    designTeam: 'Franklin Ombui, Studio 39+',
    typology: 'Contemporary Private Residence',
    siteFeatures: 'Landscaped courtyards, paved circulation, semi-outdoor verandas, garden-facing rooms',
    ...
    seoKeywords: [
      'Contemporary house Nairobi',
      'Residential architecture Kenya',
      'Modern African house',
      'Mazeras stone architecture',
      'Studio 39+',
      'Luxury residential design Kenya'
    ],
    gallery: [
      {
        src: '/projects/saika-house/hero.jpg',
        title: 'Garden frontage',
        alt: 'Saika House contemporary private residence in Nairobi with Mazeras stone cladding, pitched terracotta roof, vertical screening, and landscaped garden frontage'
      },
      {
        src: '/projects/saika-house/garden-arrival.jpg',
        title: 'Framed arrival',
        alt: 'Saika House exterior render showing planted arrival path, Mazeras stone, textured plaster, and warm residential proportions'
      },
      {
        src: '/projects/saika-house/courtyard-path.jpg',
        title: 'Courtyard circulation',
        alt: 'Landscaped courtyard path at Saika House with garden-facing rooms, textured plaster walls, and terracotta roof tones'
      },
      {
        src: '/projects/saika-house/courtyard-wide.jpg',
        title: 'Quiet courtyard',
        alt: 'Wide courtyard perspective of Saika House showing human-scaled circulation, planted edges, and refined residential planning'
      },
      {
        src: '/projects/saika-house/garage-approach.jpg',
        title: 'Garage approach',
        alt: 'Garage and front approach view of Saika House with vertical black screens, paved circulation, stone cladding, and pitched roof'
      },
      {
        src: '/projects/saika-house/aerial-courtyard.jpg',
        title: 'Aerial organization',
        alt: 'Aerial render of Saika House showing courtyard-style spatial organization, terracotta roofs, perimeter wall, and landscaped outdoor rooms'
      },
      {
        src: '/projects/saika-house/landscape-edge.jpg',
        title: 'Garden edge',
        alt: 'Saika House garden edge showing textured plaster walls, landscaped planting, paved path, and warm residential courtyard atmosphere'
      },
      {
        src: '/projects/saika-house/courtyard-living.jpg',
        title: 'Indoor-outdoor threshold',
        alt: 'Saika House courtyard living threshold with Mazeras stone, vertical screening, paved circulation, and garden-facing spaces'
      },
      {
        src: '/projects/saika-house/screened-service.jpg',
        title: 'Screened service edge',
        alt: 'Screened service and circulation zone at Saika House with timber tones, stone wall, and landscaped courtyard movement'
      }
    ],
    drawings: [
      {
        title: 'Site Plan',
        src: '/projects/saika-house/site-plan.pdf',
        alt: 'Site plan drawing for Saika House contemporary private residence in Saika Nairobi'
      },
      {
        title: 'Ground Floor Plan',
        src: '/projects/saika-house/ground-floor-plan.pdf',
        alt: 'Ground floor plan drawing for Saika House by Studio 39+'
      },
      {
        title: 'North Elevation',
        src: '/projects/saika-house/north-elevation.pdf',
        alt: 'North elevation drawing showing Saika House roof proportions, wall surfaces, and residential facade rhythm'
      },
      {
        title: 'South Elevation',
        src: '/projects/saika-house/south-elevation.pdf',
        alt: 'South elevation drawing for Saika House with contemporary residential proportions'
      },
      {
        title: 'Section 01',
        src: '/projects/saika-house/section-01.pdf',
        alt: 'Architectural section drawing through Saika House showing roof and spatial relationships'
      },
      {
        title: 'Section 02',
        src: '/projects/saika-house/section-02.pdf',
        alt: 'Architectural section drawing showing Saika House construction and residential development details'
      },
      {
        title: 'Window Schedule',
        src: '/projects/saika-house/window-schedule.pdf',
        alt: 'Window schedule drawing for Saika House construction drawings'
      },
      {
        title: 'Door Schedule',
        src: '/projects/saika-house/door-schedule.pdf',
        alt: 'Door schedule drawing for Saika House construction drawings'
      }
    ],
    palette: [
      {
  ...
  {
    id: 'earthen-threshold',
    name: 'Earthen Threshold',
    subtitle: 'Outdoor Brick WC Pavilion',
    cardSubtitle: 'Experimental Brick Pavilion',
    category: 'Outdoor WC Pavilion',
    location: 'Bomachoge, Kisii, Kenya',
    year: '2026',
    status: 'Concept Design',
    studio: 'Studio 39+',
    architect: 'Franklin Ombui',
    designTeam: 'Franklin Ombui, Studio 39+',
    typology: 'Outdoor WC Pavilion',
    materialLanguage: 'Exposed face brick, perforated masonry, natural light, textured surfaces',
    area: 'TBC',
    ...
    seoKeywords: [
      ...
      'Minimal brick architecture',
      'Architectural pavilion Kenya',
      'Studio 39+',
      'Perforated brick architecture'
    ],
    gallery: [
      {
        src: '/projects/earthen-threshold/exterior-threshold.jpg',
        title: 'Brick threshold',
        alt: 'Earthen Threshold outdoor brick WC pavilion exterior with exposed red brick, frosted glazing, and perforated masonry screen in Bomachoge Kisii'
      },
      {
        src: '/projects/earthen-threshold/brick-screen-exterior.jpg',
        title: 'Perforated screen',
        alt: 'Perforated brick facade of Earthen Threshold filtering daylight and ventilation through exposed masonry'
      },
      {
        src: '/projects/earthen-threshold/corridor-filtered.jpg',
        title: 'Filtered corridor',
        alt: 'Interior brick corridor of Earthen Threshold with perforated masonry ceiling and wall filtering light and air'
      },
      {
        src: '/projects/earthen-threshold/shower-brick-light.jpg',
        title: 'Shower chamber',
        alt: 'Outdoor WC shower space enclosed by tactile exposed red brick surfaces with natural overhead light'
      },
      {
        src: '/projects/earthen-threshold/corridor-warm.jpg',
        title: 'Warm passage',
        alt: 'Warm brick corridor with basin, timber doors, frosted glazing, and shadow play inside Earthen Threshold pavilion'
      },
      {
        src: '/projects/earthen-threshold/basin-screen.jpg',
        title: 'Basin and screen',
        alt: 'Basin area beside perforated brick screen showing filtered daylight and natural ventilation in a minimal brick pavilion'
      },
      {
        src: '/projects/earthen-threshold/muted-exterior.jpg',
        title: 'Muted monolith',
        alt: 'Muted exterior render of Earthen Threshold emphasizing monolithic brick mass and sculptural pavilion presence'
      }
    ],
    drawings: [
      {
        title: 'Floor Plan',
        src: '/projects/earthen-threshold/floor-plan.pdf',
        alt: 'Floor plan drawing for Earthen Threshold outdoor brick WC pavilion by Studio 39+'
      },
      {
        title: 'Roof Plan',
        src: '/projects/earthen-threshold/roof-plan.pdf',
        alt: 'Roof plan drawing showing the mono-pitch roof strategy for Earthen Threshold'
      },
      {
        title: 'Elevation 01',
        src: '/projects/earthen-threshold/elevation-01.pdf',
        alt: 'Architectural elevation drawing of Earthen Threshold brick pavilion'
      },
      {
        title: 'Elevation 02',
        src: '/projects/earthen-threshold/elevation-02.pdf',
        alt: 'Architectural elevation drawing showing perforated masonry language of Earthen Threshold'
      },
      {
        title: 'Section 01',
        src: '/projects/earthen-threshold/section-01.pdf',
        alt: 'Architectural section drawing through Earthen Threshold outdoor WC pavilion'
      },
      {
        title: 'Section 02',
        src: '/projects/earthen-threshold/section-02.pdf',
        alt: 'Architectural section drawing showing roof, brick enclosure, and interior thresholds'
      }
    ],
    palette: [
      {
  ...
  {
    id: 'ukwala-residence',
    name: 'Ukwala Residence',
    category: 'Private Residence',
    location: 'Ukwala, Siaya, Kenya',
    year: '2026',
    status: 'Approval drawings / concept development',
    studio: 'Studio 39+',
    architect: 'Franklin Ombui',
    designTeam: 'Franklin Ombui, Studio 39+',
    ...
    seoKeywords: [
      'Luxury residence Kenya',
      'Modern tropical architecture',
      'Studio 39+',
      'Architectural design Kenya',
      'Contemporary African residence'
    ],
    gallery: [
      {
        src: '/projects/ukwala/arrival-wide.jpg',
        title: 'Arrival facade',
        alt: 'Ukwala Residence exterior arrival facade with natural stone cladding, timber screens, textured plaster, and glazed double-volume entry'
      },
      {
        src: '/projects/ukwala/entrance.jpg',
        title: 'Double-volume entrance',
        alt: 'Double-volume entrance composition at Ukwala Residence with vertical timber door, tall glazing, and warm plaster surfaces'
      },
      {
        src: '/projects/ukwala/material-closeup.jpg',
        title: 'Filtered facade detail',
        alt: 'Close-up of vertical timber fins, textured plaster, stone, and filtered light at Ukwala Residence'
      },
      {
        src: '/projects/ukwala/rear-screen.jpg',
        title: 'Rear terrace screen',
        alt: 'Rear elevation of Ukwala Residence showing timber privacy fins, glazed openings, balcony, and garden continuity'
      },
      {
        src: '/projects/ukwala/gate.jpg',
        title: 'Gate approach',
        alt: 'Gate approach to Ukwala Residence with timber slatted boundary wall, warm light, landscaping, and stone surfaces'
      },
      {
        src: '/projects/ukwala/garden-elevation.jpg',
        title: 'Garden elevation',
        alt: 'Garden elevation of Ukwala Residence with balcony planting, glazed rooms, vertical timber accents, and textured plaster'
      }
    ],
    drawings: [
      {
        title: 'Ground Floor Plan',
        src: '/projects/ukwala/ground-floor-plan.pdf',
        alt: 'Ground floor architectural plan for Ukwala Residence by Studio 39+'
      },
      {
        title: 'First Floor Plan',
        src: '/projects/ukwala/first-floor-plan.pdf',
        alt: 'First floor architectural plan for Ukwala Residence by Studio 39+'
      },
      {
        title: 'Roof Plan',
        src: '/projects/ukwala/roof-plan.pdf',
        alt: 'Roof plan drawing for Ukwala Residence by Studio 39+'
      },
      {
        title: 'Elevations',
        src: '/projects/ukwala/elevation-01.pdf',
        alt: 'Elevation drawing for Ukwala Residence showing contemporary tropical facade proportions'
      },
      {
        title: 'Sections',
        src: '/projects/ukwala/section-01.pdf',
        alt: 'Section drawing for Ukwala Residence showing vertical spatial relationships and double-volume areas'
      }
    ],
    palette: [
      {
